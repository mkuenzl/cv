	...
	return (
		<html>
			{/* <Helmet>
				...
				<meta
					name="description"
					content="Personal portfolio website build with react. This website was used as a learning experience and to represent myself on the internet."
				/>
				<meta name="theme-color" content="#E6E6FA" />
				<meta
					name="keywords"
					content="cv, moritz, künzl, moritz künzl, portfolio, personal website, github pages, lebenslauf, developer, trier, weidengraben, universität trier, softwareentwicklung, frontend, backend"
				/>
				...
				<meta
					...
					content="KQgd_JEMUo9-726TMW1qDM9FyEOcUx9uGrkn5pvO-Kc"
				/>
				...
				<meta
					name="og:image"
					content="src/assets/pictures/moritz-kuenzl-portrait.jpg"
				/>
			</Helmet> */}
